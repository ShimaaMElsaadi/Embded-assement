...
//takes a pointer to the allocated space in the free store.
  void
display (struct stud *ptr)	// to display the information of a student
{
...
//display the information of students in a linked list.
  void
display_all ()			//to display information of all students
{
...
//takes a pointer to the structure data in the free store.
  void
insert_linked (struct node *newNode) 
{
...
//with data variable(S).
  void
Dynamic_arrayofstudents (struct stud *A) 
{
...
//and a structure for the new_student data in the stack.
  void
arry_insert (struct stud *Temp, struct stud newNode) 
{
  info(&newNode);
...
//working
  void
display_all_arry (struct stud *ptr)	//to display information of all students
{
